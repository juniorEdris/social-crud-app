...
export const FindFriendsIcon = ({ customClasses = "w-6 h-6" }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
...
export const ExitIcon = ({ customClasses = "w-6 h-6" }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
...
export const EnterIcon = ({ customClasses = "w-6 h-6" }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
...
export const CrossCancel = ({ customClasses = "w-6 h-6" }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
...
export const LikeOutline = ({ customClasses = "w-6 h-6 " }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
...
export const LikeSolid = ({ customClasses = "w-6 h-6" }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
export const CommentOutline = ({ customClasses = "w-6 h-6" }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
...
export const CommentSolid = ({ customClasses = "w-6 h-6" }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
...
export const OptionsIcon = ({ customClasses = "w-6 h-6" }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
...
export const SpinIcon = ({ customClasses = "w-8 h-8" }) => {
  return (
    <div role="status">
      <svg
        className={`inline mr-2 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600 ${customClasses}`}
        viewBox="0 0 100 101"
        fill="none"
        xmlns="http://www.w3.org/2000/svg"
      >
